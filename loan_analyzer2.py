...
#print("The total of all loans is", sum_of_loans)
...
#average = sum_of_loans / total_number_loans
...
#else:
    #print("loan is too expensive and not worth it")
...
with open(csvpath, "w") as csvfile:
    csvwriter = csv.writer(csv, delimer=",")
